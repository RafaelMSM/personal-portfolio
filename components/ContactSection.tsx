...
export default function ContactSection() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      value: 'rafael-medeiros-509524214',
          ...
          >
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-slate-800 rounded-lg flex items-center justify-center mr-4 group-hover:bg-slate-700 transition-colors duration-300">
